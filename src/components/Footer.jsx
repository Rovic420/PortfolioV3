...
const Footer = () => {
  ...
  const stats = [
    { icon: Code, label: "Lines of Code", value: "800K+", color: "text-blue-400" },
    { icon: Coffee, label: "Coffee Cups", value: "5000+", color: "text-orange-400" },
    { icon: Zap, label: "Projects", value: "1+", color: "text-yellow-400" },
    { icon: Users, label: "Happy Clients", value: "2+", color: "text-green-400" },
  ]
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed mb-6 max-w-md text-sm sm:text-base">
                I create clean, interactive, and 
                visually appealing websites with a mix of design and code. Let’s build something amazing together.
              </p>
      ...
      <Modal isOpen={showTermsOfService} onClose={() => setShowTermsOfService(false)} title="Terms of Service">
        <ServiceTerms />
      </Modal>
    </>
  )
